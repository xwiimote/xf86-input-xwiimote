...
void handle_analog_stick_event(struct analog_stick *stick, struct analog_stick_config *config, struct xwii_event *ev, int stick_index, unsigned int state, InputInfoPtr info);
